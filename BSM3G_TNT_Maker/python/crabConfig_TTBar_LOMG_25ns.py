...
config.General.requestName = 'RunIISpring15MiniAODv2_TTJets_madgraphMLM_Asympt25ns'
...
config.Data.publishDataName = 'TTJets_madgraphMLM_Asympt25ns_TNTMaker_MiniAODv2'
